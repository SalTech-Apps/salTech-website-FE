...
function About() {
  return (
    <div className=" bg-background">
      {/* Header Section */}
      <section className="text-center p-8 w-3/4 mx-auto">
        ...
        <p className=" mt-4 max-w-2xl mx-auto">
          ...
          that guide our business. With business transformation in mind, our
      ...
      <LeftTextSection
        ...
        description={
          <>
            All profits from our domestic businesses are reinvested within the
      ...
      <RightTextSection
        ...
        description={
          <>
            Our talent pool draws from the domestic labour market with a goal of
