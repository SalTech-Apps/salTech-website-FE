...
function ContactUs() {
  ...
  return (
    <div className=" bg-background">
      ...
      <section className=" bg-background bg-cover bg-bottom bg-[url('/layout/net.png')] dark:bg-[url('/layout/net-dark.png')]">
        <div className="container mx-auto flex flex-wrap items-center justify-between pb-12 overflow-hidden">
          {/* Image */}
          ...
          <div className="w-full md:w-1/2 mt-8 md:mt-0 px-8 md:px-12 2xl:px-14">
            ...
            <div className="border-l-3 border-primary pl-4 my-4">
              ...
              contact form, and we’ll reach out to you shortly. Got feedback?
