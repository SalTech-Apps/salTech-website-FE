...
export function SalTechProcess() {
	return (
		<section className="bg-[#faf7ef] px-4 py-16 md:px-8 md:py-22.5 lg:px-12">
			<div className="mx-auto max-w-6xl">
				<div className="mb-12 flex flex-col items-center gap-3.5 text-center">
					...
					<p className="max-w-2xl text-[17px] leading-relaxed text-[#6b7280]">
				...
				<div className="relative grid gap-12 lg:grid-cols-3 lg:gap-6">
					<div
						className="pointer-events-none absolute left-[10%] right-[10%] top-7 hidden h-0.5 bg-[#e5e7eb] lg:block overflow-hidden"
						aria-hidden
					/>
					{STEPS.map((s) => (
						<div
