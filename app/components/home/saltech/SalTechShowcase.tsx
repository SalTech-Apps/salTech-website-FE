	...
	return (
		<section className="relative min-h-[480px] overflow-hidden bg-[#fafafa] md:min-h-[620px] lg:min-h-[779px]">
			...
			<div className="relative mx-auto flex max-w-7xl flex-col items-center justify-center px-4 pb-16 pt-10 lg:block lg:min-h-[620px] lg:px-8 lg:pb-24 lg:pt-20">
				...
				<div className="relative z-2 mt-6 flex w-full max-w-lg justify-center lg:absolute lg:right-[8%] lg:top-[107px] lg:mt-0 lg:max-w-[250px] lg:justify-end xl:right-1">
					<img
				...
				<div className="relative z-2 mt-4 flex w-full max-w-lg justify-center lg:absolute lg:left-2 lg:top-[428px] lg:mt-0 lg:max-w-[242px] lg:justify-start">
					<img
